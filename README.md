...
```bash
git clone https://github.com/byteninja01/SereneMind.git
cd SereneMind
```
...
Open [(https://studio.firebase.google.com/studio-4661325956)] to view the app in your browser.

---

## 🏆 Hackathon Submission

This project was built as part of the **Oxibook Hackathon 2025** to promote mental wellness through technology.
...
This project is made from Firebase Editor.
